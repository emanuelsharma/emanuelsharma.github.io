...
import { Pass, FullScreenQuad } from "https://unpkg.com/three@0.141.0/examples/jsm/postprocessing/Pass.js";
	...
	get fragmentShader() {
		return `
			...
			float getPixelDepth(int x, int y) {
				...
				return readDepth(depthBuffer, vUv + width * screenSize.zw * vec2(x, y));
			}
			vec3 getPixelNormal(int x, int y) {
				return texture2D(normalBuffer, vUv + width * screenSize.zw * vec2(x, y)).rgb;
			}
